...
class sut(object):
    ...
    def state(self):
        ...
        return [ copy.deepcopy(self.p_INT),copy.deepcopy(self.p_INT_used),copy.deepcopy(self.p_AVL),copy.deepcopy(self.p_AVL_used),copy.deepcopy(self.p_LIST),copy.deepcopy(self.p_LIST_used),copy.deepcopy(self.p_AVL_REF),copy.deepcopy(self.p_AVL_REF_used)]
